...
exports.create=(req,res)=>{
    const healths=new Health ({
        ...
        record:{
            record_height:req.body.record_height,
            record_weight:req.body.record_weight,
            record_lab_test:req.body.record_lab_test,
            record_diagnose:req.body.record_diagnose,
            record_prescription:req.body.record_prescription,
